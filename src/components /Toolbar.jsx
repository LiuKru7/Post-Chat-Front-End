    ...
    return (
        <div className="p-3 d-flex bg-info border-bottom border-3 border-black">
            <div className="d-flex justify-content-around align-items-start flex-grow-1">
                <Button variant={toolbarInfo===1 ? "success" : "primary"} onClick={profileNav} className="px-5">Profile</Button>
                <Button variant={toolbarInfo===2 ? "success" : "primary"} onClick={messagesNav} className="px-5">Messages</Button>
                <Button variant={toolbarInfo===3 ? "success" : "primary"} onClick={postsNav} className="px-5">Posts</Button>
                <Button variant={toolbarInfo===4 ? "success" : "primary"} onClick={usersNav} className="px-5">Users</Button>
            </div>
