...
import {setAllPosts} from "../features/info.jsx";
    ...
    return (
        <div className="p-0 m-0 position-relative">
            ...
            <div className="d-lg-flex  ">
                ...
                <div
                    className="d-none  bg-body-secondary m-lg-5 mx-5 my-2  px-lg-5 py-3 w-75 d-md-flex justify-content-between align-items-start border-radius-20 ">
                ...
                <div
                    className="d-md-none  bg-body-secondary m-lg-5 mx-5 my-2  px-lg-5 py-3 w-75 d-flex justify-content-between align-items-start border-radius-20 ">
                    <div className=""><span className="fs-4 fw-bold">Sort By:</span></div>
